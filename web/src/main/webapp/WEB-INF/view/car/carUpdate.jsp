...
<form method="post" action="/updateCar" >
    ...
    <table border="1" cellpadding="5">
        ...
        <tr>
            <th>Год выпуска: </th>
            <td>
                <input type="number" name="rentDay" size="5"  value="<c:out value="${car.carYear}" />"
                />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <input type="number" name="priceDay" size="5"  value="<c:out value="${car.priceDay}" />"
                />
            </td>
        </tr>
        <tr>
...
<a href="<c:url value='/getCar' />">Получить список</a>
<br>
